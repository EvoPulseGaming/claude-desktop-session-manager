---
description: Open the Claude Session Manager GUI - checkbox-select sessions and copy / move / remove them across accounts
allowed-tools: [Bash]
---

# Open Claude Session Manager

Launch the native GUI that lists every Claude Desktop session across all signed-in accounts with checkboxes, an account filter, a copy/move target picker, and copy / move / remove buttons.
...
- After making changes, they must FULLY restart Claude Desktop to see them.

If they'd prefer a non-GUI, scripted flow instead, point them at `/consolidate-sessions`.
